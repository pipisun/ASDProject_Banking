...
public abstract class AddCutomerDialog extends javax.swing.JDialog {
	...
	public AddCutomerDialog(String custType) {
		...
		JLabel1.setBounds(12, 36, 60, 24);
		JLabel2.setText("Street");
		getContentPane().add(JLabel2);
		JLabel2.setForeground(java.awt.Color.black);
		JLabel2.setBounds(12, 60, 60, 24);
		JLabel3.setText("City");
		getContentPane().add(JLabel3);
		JLabel3.setForeground(java.awt.Color.black);
		JLabel3.setBounds(12, 84, 60, 24);
		JLabel4.setText("State");
		getContentPane().add(JLabel4);
		JLabel4.setForeground(java.awt.Color.black);
		JLabel4.setBounds(12, 108, 60, 24);
		JLabel5.setText("Zip");
		getContentPane().add(JLabel5);
		JLabel5.setForeground(java.awt.Color.black);
		JLabel5.setBounds(12, 132, 60, 24);
		JLabel6.setText("Email");
		getContentPane().add(JLabel6);
		JLabel6.setForeground(java.awt.Color.black);
		JLabel6.setBounds(12, 156, 60, 24);
		getContentPane().add(JTextField_NAME);
		JTextField_NAME.setBounds(130, 36, 156, 20);
		getContentPane().add(JTextField_STR);
		JTextField_STR.setBounds(130, 60, 156, 20);
		getContentPane().add(JTextField_CT);
		JTextField_CT.setBounds(130, 84, 156, 20);
		getContentPane().add(JTextField_ST);
		JTextField_ST.setBounds(130, 108, 156, 20);
		getContentPane().add(JTextField_ZIP);
		JTextField_ZIP.setBounds(130, 132, 156, 20);
		getContentPane().add(JTextField_EM);
		JTextField_EM.setBounds(130, 156, 156, 20);
		...
		JButton_Calcel.setBounds(156, 216, 100, 24);

		if ("P".equalsIgnoreCase(custType)) {
			JLabel7.setText("DOB");
			getContentPane().add(JLabel7);
			JLabel7.setForeground(java.awt.Color.black);
			JLabel7.setBounds(12, 180, 250, 24);

			JTextField_BD = new javax.swing.JTextField();
			getContentPane().add(JTextField_BD);
			JTextField_BD.setBounds(130, 180, 156, 20);
		} else {
			JLabel7.setText("Employees Amt.");
			getContentPane().add(JLabel7);
			JLabel7.setForeground(java.awt.Color.black);
			JLabel7.setBounds(12, 180, 350, 24);

			JTextField_NoOfEmp = new javax.swing.JTextField();
			getContentPane().add(JTextField_NoOfEmp);
			JTextField_NoOfEmp.setBounds(130, 180, 156, 20);
		}
