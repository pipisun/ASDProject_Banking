package main.java.com.cs.framework.util;
...
public class DBUtil {
	...
	public static String  mapConvertParamterString( Map m ){
		...
		for (Entry<String, Object> entry : entries) {
			...
			String valueType = entry.getValue().getClass().toString();
			//System.out.println(valueType);
			if (valueType.endsWith("java.lang.String")) {
				sqlBufferCondition.append(entry.getKey()+"='"+entry.getValue()+"'");
			}else if ( valueType.endsWith("java.lang.Int") || valueType.endsWith("java.lang.Long") || valueType.endsWith("java.lang.Short") || valueType.endsWith("java.lang.Float") || valueType.endsWith("java.lang.Double")) {
				sqlBufferCondition.append(entry.getKey()+"="+entry.getValue());
			}else {
				System.err.println("mapConvertParamterString:"+valueType);
			}
			System.out.println("sqlBufferCondition.toString():"+sqlBufferCondition.toString());
		}
		return sqlBufferCondition.toString();
	}
